...
export type GetAudit_logsGroupByPayload<T extends audit_logsGroupByArgs> =
...
export type audit_logsWhereInput = {
  ...
  record_id?:
    | Prisma.BigIntNullableFilter<'audit_logs'>
    | bigint
    | number
    | null;
...
export type audit_logsScalarWhereWithAggregatesInput = {
  ...
  user_id?:
    | Prisma.BigIntNullableWithAggregatesFilter<'audit_logs'>
    | bigint
    | number
    | null;
  ...
  created_at?:
    | Prisma.DateTimeWithAggregatesFilter<'audit_logs'>
    | Date
    | string;
};
