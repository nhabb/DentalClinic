        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10 space-y-8">
          ...
          <div className="text-center">
            <Link href="/" className="inline-flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-auth-blue-dark to-auth-blue-light bg-clip-text text-transparent">BrightSmile</span>
            </Link>
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-auth-blue hover:text-auth-blue-light">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white gradient-auth-card hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-auth-blue transition-all transform hover:scale-[1.02]"
              >
                Sign in
              </button>
            </div>
